 		...
 		new  Ext.Button({
	      	   ...
	      	   listeners:{
		            'click': function(){
		                ...
		                ajaxDivUpdater('TemplateAction.action','parameter=compensaListaTransferencias&fecha='+Ext.getCmp('fechaAplicaExt').value+'&banco='+Ext.getCmp('bancoAplicaExt').value+'&importe='+Ext.getDom('importe').value+'&fecha2='+Ext.getCmp('fechaAplicaFinExt').value,'listaTransferenciaAplica'); 
		            }
		    	}
	      });
...
<div class="instrucciones">	
	...
	- <b>Programar:</b> La transferencia sera programada para su compensacion en SAP. Podra visualizarla en las compensaciones EN PROCESO, una vez sea compensada se vera reflejada en APLICADAS o si ocurrio algun error en ERROR.<br/> 
</div>
