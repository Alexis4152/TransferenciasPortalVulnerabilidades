	      	   ...
	      	   listeners:{
		            'click': function(){
		              ...
		              try{
		                ...
		                ajaxDivUpdater('TemplateAction.action','parameter=detalleTransferenciaExecuteCompensacion&lista=lista&'+Ext.Ajax.serializeForm('listaAplicaForm'),'listaTransferenciaAplica'); 
		            }
		    	}
	      });     
