 		...
 		new  Ext.Button({
	      	   ...
	      	   listeners:{
		            'click': function(){
		                ...
		                ajaxDivUpdater('Reportes.action','parameter=reporteCiclo&filtros=ok&fecha='+Ext.getCmp('fechaInicio<c:out value="${panelId}"/>Ext').value+'&fecha2='+Ext.getCmp('fechaFin<c:out value="${panelId}"/>Ext').value,'grafica<c:out value="${panelId}"/>'); 
		            }
		    	}
	      });
...
<div class="instrucciones">
	<b>El reporte muestra el número de transferencias aplicadas por cada ciclo corporativo y el porcentaje de cada uno.</b><br/>
	Instrucciones:<br/>		
	...
	<div id="grafica<c:out value="${panelId}"/>" style="width: 100%; display: inline-flex;"/>
</div>
</div>