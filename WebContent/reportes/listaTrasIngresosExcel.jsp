...
<% response.setHeader("Content-Disposition", "attachment; filename=\"TransIngresos.xls\"");%>
...
<body>
	...
	<div style="width: 100%" align="center">
		<table style="width: 70%; border: 1px solid #0681d2;" id="TransIngresos">
