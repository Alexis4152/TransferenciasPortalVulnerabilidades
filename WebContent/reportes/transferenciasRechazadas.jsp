		    ...
		    items: [ 
		        { 
		            ...
		            'click': function(){
		            	...
		            	var redirect = 'Reportes.action?filtros=ok&parameter=transferenciasRechazadas&'+Ext.Ajax.serializeForm('listaTraExcelUsuario'); 
 		...
 		new  Ext.Button({
	      	   ...
	      	   listeners:{
		            'click': function(){
		                ...
		                ajaxDivUpdater('Reportes.action','parameter=transferenciasRechazadas&filtros=ok&fecha='+Ext.getCmp('fechaInicio<c:out value="${panelId}"/>Ext').value+'&fecha2='+Ext.getCmp('fechaFin<c:out value="${panelId}"/>Ext').value+'&banco='+Ext.getCmp('banco<c:out value="${panelId}"/>Ext').value,'concentradoTransferencia<c:out value="${panelId}"/>'); 
		            }
		    	}
	      });
