...
new Ext.form.ComboBox({
    ...
    editable : false
	  ...
	  new  Ext.Button({
     	   ...
     	   listeners:{
	            'click': function(){
	            	...
	            	ajaxDivUpdater('TemplateAction.action','parameter=updatePeticion&idPeticion=${idPeticion}&idEmpleado='+Ext.getCmp('nombre').value+'&horarioIn='+Ext.getCmp('horarioIn').value+'&horarioOut='+Ext.getCmp('horarioOut').value+'&asistencia='+Ext.getCmp('asistencia').value+'&periodoIn='+Ext.getCmp('periodoInExt').value+'&periodoOut='+Ext.getCmp('periodoOutExt').value+'&mensajes='+Ext.getCmp('mensajes').value,'updatePet');  
	  ...
	  new  Ext.Button({
   	   ...
   	   listeners:{
	            'click': function(){
	            	...
	            	ajaxDivUpdater('TemplateAction.action','parameter=eliminarPeticion&idPeticion=${idPeticion}','updatePet');  
	            }
	    	}
   });
	  ...
	  new  Ext.Button({
    	   ...
    	   listeners:{
	            'click': function(){
	            	 Ext.getCmp('editPeticionWindowExt').close();
	  	            }
...
<div>
	...
	<div>
		...
		<form id="desglosePagosForm">
			<table cellspacing="5px" style="width:10%">
				<thead>
				...
				<tbody>
					<tr>
						...
						<td width="200px"><select id="asistencia<c:out value="${panelId}"/>">
